...
$(function () {
  ...
  // 2. 아이디 선택자
  // 자바스크립트 방식 -> id가 id1인 글씨 색깔(color) 변경 (색상 자유롭게)
  ...
  $(".item").css({ color: "yellowgreen", "background-color": "green" });

  // 4. 자식 선택자와 자손 선택자
  $("ul > li").css("color", "green");
  $("ul > .ch").css("background-color", "lime");
  $("ul h3").css({ color: "indianred", "background-color": "khaki" });
